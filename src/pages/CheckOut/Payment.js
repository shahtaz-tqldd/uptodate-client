...
const Payment = () => {
    ...
    const handlePayment = () => {
        ...
        fetch('https://dev-blog-server.vercel.app/payment/', {
            method: 'POST',
            headers: {
    ...
    return (
        <section className='max-w-[1250px] mt-24 mx-auto px-4 mb-16'>
            <h3 className='text-5xl text-success font-bold mt-32'>Congratulations!</h3>
            ...
            <div className='mt-16 text-lg'>
                ...
                <div className='mt-4 mb-6 text-base-content'><span className='text-5xl font-bold text-info'>BDT 200</span>/year</div>
